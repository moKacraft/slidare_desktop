...
public class TrackingServiceStub implements TrackingService
{
	...
	ContactsBusiness contactsctrl = new ContactsBusiness();
...
//				projectsMap.get(contact.getGroup()).remove(contact.getId());
	 ...
	 * Exemple : {1=issuetrackinglite.model.Group, 2=issuetrackinglite.model.Group}
	 */
...
//			System.out.println("contactsMapChangeListener .onChanged()");
	 ...
	 * Exemple : {1=issuetrackinglite.model.Contact@3138cc8e, 2=issuetrackinglite.model.Contact@915673f}
	 */
